...
public class Programa {
    ...
    private static void cadastrarAutomaticamente() {
        ...
        produtos.add(new ProdutoHigiene(9.99, 10, "Sabonete", "2025-12-05", "corporal"));
        produtos.add(new ProdutoHigiene(5.49, 20, "Pasta de dente", "2026-01-04", "dental"));


        produtos.add(new Remedio(19.90, 10, "Paracetamol", "2026-01-03", "Vermelha", "Dor de cabeça"));
        produtos.add(new Remedio(24.50, 8, "Ibuprofeno", "2026-04-24", "Preta", "Inflamação"));
 

        produtos.add(new Maquiagem(49.90, 10, "Base líquida", "2026-01-27", "nacional", "luxo", "bege", "oleosa"));
        produtos.add(new Maquiagem(39.90, 15, "Batom matte", "2025-12-18", "internacional", "popular", "vermelho", "todas"));


        produtos.add(new TinturaParaCabelo(29.90, 10, "Tintura Preto", "2026-01-19", "nacional", "popular", "liso", "preto"));
        produtos.add(new TinturaParaCabelo(34.90, 8, "Tintura Ruivo", "2026-02-11", "internacional", "luxo", "cacheado", "ruivo"));
    ...
    private static void cadastrarProduto() {
        ...
        switch (tipo) {
            case 1 -> {
                ...
                produtos.add(new ProdutoHigiene(preco, quantidade, nome, validadeEmString, tipoHigiene));
            }
            case 2 -> {
                ...
                produtos.add(new Remedio(preco, quantidade, nome, validadeEmString, tarja, sintomas));
            }
            case 3 -> {
                ...
                produtos.add(new Maquiagem(preco, quantidade, nome, validadeEmString, internacional, luxo, cor, tipoPele));
            }
            case 4 -> {
                System.out.print("Internacional (sim/nao): ");
                ...
                produtos.add(new TinturaParaCabelo(preco, quantidade, nome, validadeEmString, intl, lux, tipoCabelo, corTintura));
            }
            case 5 -> {
                ...
                produtos.add(new ProdutoAlimenticio(preco, quantidade, nome, validadeEmString, tipoComida, fitness));
                break;
            }
            default -> {
   ...
   private static void ordenarProduto() {
